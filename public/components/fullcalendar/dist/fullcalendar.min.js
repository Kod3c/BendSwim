...
!(function(a) {
	...
	function d(b) {
		...
		return (
			a.each(b, function(b, e) {
				'views' != b &&
					(a.isPlainObject(e) && !/(time|duration|interval)$/i.test(b) && -1 == a.inArray(b, Ra)
						? ((c = null),
	...
	function A(b) {
		...
		for (
			'string' == typeof b
				? (f = b.split(/\s*,\s*/))
				: 'function' == typeof b ? (f = [ b ]) : a.isArray(b) && (f = b),
				c = 0;
			c < f.length;
			c++
		)
	...
	function D(b, c) {
		return b || c
			? null == c
				...
				: null == b
					? 1
					: 'string' === a.type(b) || 'string' === a.type(c) ? String(b).localeCompare(String(c)) : b - c
			: 0;
	}
	function E(a, b) {
		var c,
	...
	function la(a, b) {
		...
		return 'string' == typeof b
			...
			: (c = b.token)
				? bb[c] ? bb[c](a) : ia(a, c)
				: b.maybe && ((d = ka(a, b.maybe)), d.match(/[1-9]/)) ? d : '';
	}
	...
	function qa(a) {
		for (var b, c = [], d = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; (b = d.exec(a)); )
			b[1]
				? c.push(b[1])
				: b[2] ? c.push({ maybe: qa(b[2]) }) : b[3] ? c.push({ token: b[3] }) : b[5] && c.push(b[5]);
		return c;
	}
	function ra() {}
	function sa(a, b) {
				...
				f &&
					a.each(f.split(' '), function(d) {
						...
						a.each(this.split(','), function(d, e) {
									...
									j &&
										...
										(q = k
											...
											: m && c.theme
												...
												: o && !c.theme ? "<span class='fc-icon fc-icon-" + o + "'></span>" : Y(l)),
							...
							h &&
								g.first().addClass(n + '-corner-left').end().last().addClass(n + '-corner-right').end(),
							g.length > 1
	...
	function Na(c) {
		...
		function i(b) {
			...
			if (
				(a.isFunction(b) || a.isArray(b)
					? (c = { events: b })
					: 'string' == typeof b ? (c = { url: b }) : 'object' == typeof b && (c = a.extend({}, b)),
				c)
			) {
				for (
					c.className
		...
		function u(a) {
			v(a),
				...
				a.end || (c.forceEventDuration ? (a.end = K.getDefaultEventEnd(a.allDay, a.start)) : (a.end = null));
		}
		function v(a) {
			...
			return (
				...
				a.each(b, function(b, j) {
					...
					(k = { start: j.start.clone(), end: j.end ? j.end.clone() : null, allDay: j.allDay }),
						...
						u(l),
						c ? (l.end = null) : f && !l.end && (l.end = K.getDefaultEventEnd(l.allDay, l.start)),
	...
	(Pa.moment = function() {
		...
		(_a.week = _a.weeks = function(a) {
			...
			return null == a && 'function' == typeof b
				? b(this)
				: 'ISO' === b ? ab.isoWeek.apply(this, arguments) : ab.week.apply(this, arguments);
		}),
		(_a.time = function(a) {
		...
		(_a.local = function() {
			var a = this.toArray(),
				b = this._ambigZone;
			return (
				ab.local.apply(this, arguments), (this._ambigTime = !1), (this._ambigZone = !1), b && Xa(this, a), this
			);
		}),
		(_a.utc = function() {
		...
		(_a.format = function() {
			return this._fullCalendar && arguments[0]
				...
				: this._ambigTime
					? ia(this, 'YYYY-MM-DD')
					: this._ambigZone ? ia(this, 'YYYY-MM-DD[T]HH:mm:ss') : ab.format.apply(this, arguments);
		}),
		(_a.toISOString = function() {
			return this._ambigTime
				? ia(this, 'YYYY-MM-DD')
				: this._ambigZone ? ia(this, 'YYYY-MM-DD[T]HH:mm:ss') : ab.toISOString.apply(this, arguments);
		}),
	...
	var eb = (Pa.Emitter = ra.extend({
		...
		fb = ra.extend({
			...
			render: function() {
				...
				(this.el = a('<div class="fc-popover"/>')
					...
					c.autoHide &&
						a(document).on('mousedown', (this.documentMousedownProxy = ca(this, 'documentMousedown')));
			},
		...
		hb = (Pa.DragListener = ra.extend({
			...
			mousemove: function(a) {
				...
				this.isDragging ||
					((b = this.options.distance || 1), (c = d * d + e * e), c >= b * b && this.startDrag(a)),
			...
			stopListening: function(b) {
				this.stopDrag(b),
					this.isListening &&
						(this.scrollEl &&
							(this.scrollEl.off('scroll', this.scrollHandlerProxy), (this.scrollHandlerProxy = null)),
						a(document)
			...
			getDayClasses: function(a) {
				...
				return (
					...
					a.isSame(c, 'day')
						...
						: c > a ? d.push('fc-past') : d.push('fc-future'),
					d
				);
			}
		}));
			...
			var c,
				...
				l = new ib(e, {
					...
					hitOver: function(b, h, i) {
						a.hit && (i = a.hit),
							(c = d.computeEventDrop(i.component.getHitSpan(i), b.component.getHitSpan(b), j)),
							c && !f.isEventSpanAllowed(d.eventToSpan(c), j) && (g(), (c = null)),
				...
				m = new ib(this, {
					...
					hitOver: function(b, h, j) {
						var m = e.getHitSpan(j),
							n = e.getHitSpan(b);
						(d = c ? e.computeEventStartResize(m, n, k) : e.computeEventEndResize(m, n, k)),
							d &&
		...
		getEventTimeText: function(a, b, c) {
			return (
				...
				this.displayEventTime && a.start.hasTime()
					? c && a.end ? this.view.formatRange(a, b) : a.start.format(b)
					: ''
			);
		},
	...
	var lb = (Pa.DayTableMixin = {
			...
			computeColHeadFormat: function() {
				return this.rowCnt > 1 || this.colCnt > 10
					? 'ddd'
					: this.colCnt > 1 ? this.view.opt('dayOfMonthFormat') : 'dddd';
			},
			...
			renderDates: function(a) {
				...
				for (
					this.el.html(g),
						...
						this.colCoordCache = new gb({ els: this.cellEls.slice(0, this.colCnt), isHorizontal: !0 }),
						b = 0;
					e > b;
					b++
				)
			...
			renderDrag: function(a, b) {
				return (
					...
					b && !b.el.closest(this.el).length
						? (this.renderEventLocationHelper(a, b), this.applyDragOpacity(this.helperEls), !0)
						: void 0
				);
			},
			unrenderDrag: function() {
			...
			computeTitleFormat: function() {
				return 'year' == this.intervalUnit
					...
					: 'month' == this.intervalUnit
						...
						: this.intervalDuration.as('days') > 1 ? 'll' : 'LL';
			},
	...
	var zb = (Pa.AgendaView = ob.extend({
			...
			renderDrag: function(a, b) {
				return a.start.hasTime()
					...
					: this.dayGrid ? this.dayGrid.renderDrag(a, b) : void 0;
			},
			unrenderDrag: function() {
