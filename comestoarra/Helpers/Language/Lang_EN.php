...
return [
    ...
    */
    ...
    /*
     *---------------------------------------------------------------
     * Swimmer MODULE LANGUAGE
     *---------------------------------------------------------------
     */
    "FEEDBACK_Swimmer_SUCCESSFULLY_CREATED"                 => "Swimmer account has been created successfully.",
    "FEEDBACK_Swimmer_AVATAR_SUCCESS_UPDATED"               => "Swimmer avatar has been updated successfully.",
    "FEEDBACK_Swimmer_DOES_NOT_EXIST"                       => "Swimmer does not exists !",
    "FEEDBACK_Swimmer_SUCCESS_APPOINTMENT"                  => "Swimmer lesson has been created successfully.",
    "FEEDBACK_Swimmer_ERROR_APPOINTMENT"                    => "Swimmer lesson has not been created !.",
    "FEEDBACK_Swimmer_ERROR_APPOINTMENT_FORM"               => "Swimmer lesson has not been created, please check all required fields (Appointment Date, etc.) !.",
    "FEEDBACK_Swimmer_APPOINTMENT_SUCCESS_DELETE"           => "Swimmer lesson has been deleted successfully !.",
    "FEEDBACK_Swimmer_APPOINTMENT_ERROR_DELETE"             => "Swimmer lesson has not been deleted !.",
    "FEEDBACK_Swimmer_APPOINTMENT_SUCCESS_CANCEL"           => "Swimmer lesson has been cancelled successfully !.",
    "FEEDBACK_Swimmer_APPOINTMENT_ERROR_CANCEL"             => "Swimmer lesson has not been cancelled !.",
    "FEEDBACK_Swimmer_APPOINTMENT_SUCCESS_ACTIVATE"         => "Swimmer lesson has been activated successfully !.",
    "FEEDBACK_Swimmer_APPOINTMENT_ERROR_ACTIVATE"           => "Swimmer lesson has not been activated !.",

    /*
    *---------------------------------------------------------------
    * Instructor MODULE LANGUAGE
    *---------------------------------------------------------------
    */
    "FEEDBACK_Instructor_SUCCESSFULLY_CREATED"                 => "Instructor account has been created successfully.",
    "FEEDBACK_Instructor_TIMETABLE_SUCCESS_UPDATED"            => "Instructor timetable has been updated successfully.",
    "FEEDBACK_Instructor_AVATAR_SUCCESS_UPDATED"               => "Instructor avatar has been updated successfully.",
    "FEEDBACK_Instructor_DOES_NOT_EXIST"                       => "Instructor does not exists !",
